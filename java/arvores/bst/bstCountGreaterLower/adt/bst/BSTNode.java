...
package arvores.bst.bstCountGreaterLower.adt.bst;
...
public class BSTNode<T extends Comparable<T>> extends BTNode<T> {
	...
	// o código abaixo é um exempo de uso do padrão Builder para construir
	// objetos do tipo BSTNode sem usar construtor diretamente.
	// o código cliente desse padrao, criando o nó vazio seria:
