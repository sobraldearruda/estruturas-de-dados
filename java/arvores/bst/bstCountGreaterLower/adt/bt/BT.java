...
package arvores.bst.bstCountGreaterLower.adt.bt;
...
public interface BT<T> {
	 ...
	 * key does not exist the method returns a NIL (empty) node.
	 */
	...
	/**
	 * Returns an array of elements filled according to the post-order
	 * traversing in a BT.
	 */
	public T[] postOrder();
